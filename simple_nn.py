...
def test_model(X_train, X_test, y_train, y_test, histone_mark_str, data_transform = None, age_transform = None):
    ...
    if histone_mark_str == "H3K4me3":
        ...
        model = create_nn(50, 3, 0.0002, 0.05, 0.1) # Best Model: simple_nn 16 3 0.0002 0.05 0.1 150 0.2 / simple_nn 16 3 0.0003 0.0 0.1 50 0.2
        auto_encoder_args = [16, 50, 0.05, 0.1, 0.2, 0.0002]
